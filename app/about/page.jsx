...
const About = () => {
  return (
    <div className="bg-[#c4c4c4] w-full max-w-full box-border text-black pb-40 overflow-x-hidden">
      {/* Navigation
      <div className="fixed bottom-0 text-white left-0 w-full z-50">
      ...
      <motion.section
        ...
        className="w-full max-w-full px-[2%] flex justify-between text-[14px] mt-2"
      >
        <motion.p
...
<motion.a
  ...
  href="/#top"
  className="relative group inline-flex items-center text-black dark:text-black gap-1"
>
  ...
  <span className="absolute left-0 -bottom-0.5 h-[1px] w-0 bg-black transition-all duration-300 group-hover:w-full"></span>
      ...
      >
        <motion.h2
          ...
          className="text-5xl md:text-5xl sm:text-4xl leading-15 mt-20 sm:mt-6 text-left text-[#333333] font-[600]"
        >
          Emotions are not just feelings, <br />
          they are physical events that <br />
          influence behavior.
        </motion.h2>
        <motion.h3
      ...
      {/* About me */}
      <section className="grid grid-cols-1 sm:grid-cols-2 mx-2 gap-60">
        <p></p>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ delay: 0.3, duration: 0.6 }}
          className="mx-10 dark:text-black"
        >
          <motion.div
          ...
          <motion.p
            ...
            className="text-md pr-2 mt-2 mr-4 leading-relaxed text-[#333333] w-[80%]"
          >
            I'm Irena — part designer, part problem-solver, part magician. /*{" "}
            <br />I specialize in simplifying complex systems and shaping them
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 mx-2 gap-60 mt-60 mx-10">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ delay: 0.3, duration: 0.6 }}
          className="mx-10 dark:text-black w-[80%]"
        >
          <motion.h2
            initial={{ y: 20, opacity: 0 }}
            whileInView={{ y: 0, opacity: 1 }}
      ...
      <motion.h2
        ...
        viewport={{ once: true }}
        transition={{ delay: 0.5, duration: 0.5 }}
        className="text-center uppercase font-[800] text-[#333333] text-6xl mt-100"
      >
        [Thank you.]
      </motion.h2>
    </div>
