...
const LastfmFeatures = () => {
  return (
    ...
    <section className="grid grid-cols-1 sm:grid-cols-3 items-center justify-center mt-20 mx-10">
    <div className="mx-10">
...
<div className="mr-20 mb-14 sm:mb-0">
      <h2 className="text-3xl sm:text-4xl bg-gradient-to-r from-gray-400 to-red-600
      bg-clip-text text-transparent leading-snug sm:leading-12 text-center ml-12 sm:ml-0 mb-10 sm:mt-10">Emphasizing engagement through thoughtful feature prioritization.</h2>
